...
import {loadParcels, loadCustomers} from '../../actions'
...
class GriddleContainer extends Component {
  ...
  onLoadCustomers = (page = 1) => {
    this.setState({currentPage: page-1, isLoading: true})
    this.props.onLoadCustomers(page);
  }
...
// getDefaultProps
GriddleContainer.defaultProps = { enableInfiniteScroll: true }
...
const mapDispatchToProps = (dispatch) => ({
  onLoadCustomers(page) {
    dispatch(loadCustomers(page))
  }
})
